...
dim(z4i<-z4[7:13,])
par(mfcol=c(2,2))
matplot(t(apply(c4[, 1:6]%*%z4[ 1:6,],2,quantile,c(.5,.025,.975))),type="l")
matplot(t(apply(c4[,7:13]%*%z4[7:13,],2,quantile,c(.5,.025,.975))),type="l")
matplot(t(apply(d4[, 1:6]%*%z4[ 1:6,],2,quantile,c(.5,.025,.975))),type="l")
matplot(t(apply(d4[,7:13]%*%z4[7:13,],2,quantile,c(.5,.025,.975))),type="l")
